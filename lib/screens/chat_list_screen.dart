...
class _ChatListScreenState extends ConsumerState<ChatListScreen> {
  ...
  int _roomUnreadCount(Map<String, dynamic>? roomData, String currentUserId) {
  ...
  Future<void> _runChatAction(
      String roomId, Future<void> Function() action, String successText) async {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text(context.l10n
                .chatListActionFailed(AppErrorText.forChat(context, e)))),
      );
    } finally {
